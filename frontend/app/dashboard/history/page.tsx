  ...
  return (
    <>
      <Topbar
        ...
        subtitle="Every dataset you've cleaned in this browser."
      />
            ...
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <Badge tone={qualityTone(entry.qualityScore)}>
                    {entry.qualityScore}/100
                  </Badge>
                </div>
                <p className="text-xs text-ink-500 mt-1">
                  Cleaned {formatDate(entry.cleaningDate)} ·{" "}
                  {formatDuration(entry.processingTimeMs)}
                </p>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <Button
                  ...
                  size="sm"
                  disabled={
                    entry.cleanedRows.length === 0 && !entry.report.downloadUrl
                  }
                  onClick={() => {
