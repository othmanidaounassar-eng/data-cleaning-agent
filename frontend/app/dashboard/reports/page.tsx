...
export default function ReportsPage() {
  ...
  return (
    <>
      <Topbar
        title="Reports"
        subtitle="Every AI cleaning report generated so far."
      />
        ...
        {entries.length === 0 ? (
          <Card className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-xs text-ink-500 mt-1">
              Clean a dataset to generate your first report.
            </p>
          </Card>
        ) : (
          entries.map((entry) => (
            <Card key={entry.id}>
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => downloadPdfReport(entry.report)}
                >
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => downloadJsonReport(entry.report)}
                >
                ...
                <Button
                  variant="secondary"
                  size="sm"
                  onClick={() => downloadCsvReport(entry.report)}
                >
